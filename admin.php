...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand me-0 px-3" href="index.php"><img src="logo/logo.png" width="40px"></a>
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="index.php">Simsaifah</a>
        ...
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">admin <?php echo $row['firstname'] ?></a>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="createArticle.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-file" aria-hidden="true">
                                    <path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="createNumber.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="createAdmin.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-admin" aria-hidden="true">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="1003" height="423"
                    style="display: block; height: 339px; width: 803px;"></canvas>
