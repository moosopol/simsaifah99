...
if (isset($_GET['delete'])) {
    ...
    if ($deletestmt) {
        ...
        header("refresh:1; url=createAdmin.php");
    }
}
...
<body>
                ...
                <div class="modal-body">
                    <form action="insert.php" id="formData" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" required class="form-control" name="created_at">
                        </div>
    ...
    <div class="container mt-5">
        ...
        <?php if (isset($_SESSION['success'])) { ?>
            <div class="alert alert-success">Register & Login
                <?php
                    ...
                    foreach ($users as $user) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a data-id="<?= $user['id']; ?>" href="?delete=<?= $user['id']; ?>"
                    ...
                    $.ajax({
                        ...
                        .done(function() {
                            Swal.fire({
                                ...
                                document.location.href = 'createAdmin.php';
                            })
                        })
                        .fail(function() {
